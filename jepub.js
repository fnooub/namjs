(function() {
    ...
    var cdnLinks = [
        "https://code.jquery.com/jquery-3.7.1.min.js",  // Link CDN 1 (jQuery)
        "https://unpkg.com/jszip/dist/jszip.min.js",  // Link CDN 2 (Lodash)
        "https://unpkg.com/ejs/ejs.min.js",  // Link CDN 2 (Lodash)
        "https://unpkg.com/jepub/dist/jepub.min.js",  // Link CDN 2 (Lodash)
    ];
    ...
    loadScriptsSequentially(cdnLinks, function() {
        ...
        (async function($, window, document, undefined) {
            ...
            const cover = await fetch('https://picsum.photos/400/600').then(response => {
            ...
            let illustration = await fetch('https://picsum.photos/400/600').then(response => {
            ...
            const byteArray = await jepub.generate('uint8array', metadata => {
                console.log('progression: ' + metadata.percent.toFixed(2) + ' %');
            });

            if (window.wvqt) {
                window.wvqt.saveEpub("lorem-ipsum", byteArray);
            }
